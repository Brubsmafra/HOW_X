    ...
    private void loghome()
        ...
        private void btnInativar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                comandoMySql.CommandText = "UPDATE livro SET status_livro = 0 WHERE id_livro = " + tbId.Text + "";
        ...
        private void btnAlterar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                comandoMySql.CommandText = "UPDATE livro SET nome_livro = '" + tbNome.Text + "', " +
                "autor_livro = '" + tbAutor.Text + "', " +
                "editora_livro = '" + tbEditora.Text + "', " +
                "categoria_livro = '" + tbCategoria.Text + "', " +
                "descricao_livro = '" + tbDescricao.Text + "', " +
                "status_livro = " + Convert.ToInt16(tbStatus.Text) + " " +
                " WHERE id_livro =  " + Convert.ToInt16(tbId.Text) ;
